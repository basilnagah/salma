            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body"style=color>
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <form class="d-flex " action="{{url('convertCurrnecyCart')}}">
                                <select class="w-50" name="currnecy" id="currnecy">
        ...
        <aside class="mt-5">
            <div class="summary">
                ...
                <div class="summary-subtotal">
                    ...
                    <div class="subtotal-value final-value" id="basket-subtotal">50</div>
                </div>
                <div class="summary-total">
                    <div class="total-title">Total</div>
                    <div class="total-value final-value" id="basket-total"> {{ 50 + $result->Result}}</div>
                </div>
